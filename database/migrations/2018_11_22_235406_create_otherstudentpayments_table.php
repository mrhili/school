...
class CreateOtherstudentpaymentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('otherstudentpayments', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('otherstudentpayments');
    }
}
