            ...
            <div class="box-body">
                  ...
                  <form id="form">
                      ...
                      <div class="col-xs-12">
                        ...
                        @include('back.partials.formG', ['name' => 'members[]', 'type' => 'select','selected' => null, 'text' => 'Les members', 'class'=>'', 'required' => true, 'array' => $members,'additionalInfo' => [ 'id' => 'members', 'multiple' => true ]])
                      </div>
                      ...
                      <div class="col-xs-12">
                        ...
                        @include('back.partials.formG', ['name' => 'name', 'type' => 'text', 'text' => 'Nom du groupe', 'class'=>'', 'required' => true, 'additionalInfo' => ['id' =>  'namefield'] ])
                      </div>
