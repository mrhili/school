        ...
        <div class="box-body" id="sbject-form">
            ...
            <form id="form">
                ...
                <div class="col-xs-12">
                    ...
                    @include('back.partials.formG', ['name' => 'videopage_id', 'type' => 'select', 'selected' => null,'text' => 'Tabulations', 'class'=>'', 'required' => true, 'array' => $tabs  ,'additionalInfo' => [ 'id' =>  'videopage_id' ]])
                </div>
    ...
    <script type="text/javascript">
        ...
        add.on("click", function(e){
            ...
            if( $('#form').valid() ){
                ...
                axios.post('/videotabs-store/'+ $('videopage_id').val() ,{
                    headers: {
