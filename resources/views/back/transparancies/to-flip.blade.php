    ...
    <div class="row">
      <div class="col-xs-12">
        @component('back.components.alert')
          <h1>Total Transparancies +: {{ $totalTrans }}</h1>
        @endcomponent
      </div>
    </div>
  </div>
  ...
  <div class="col-md-6">
    ...
    <div class="row">
      <div class="col-xs-12">
          ...
          <h1 class="text-center">Total Transparancies -</h1>
    ...
    <div class="row">
      <div class="col-xs-12">
        @component('back.components.alert')
          <h1>Total Transparancies -: {{ $totalTransMines }}</h1>
        @endcomponent
      </div>
    </div>
