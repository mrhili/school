            ...
            <div class="box-body">
                  ...
                  <form id="form">
                      ...
                      <div class="col-xs-12">
                        ...
                        @include('back.partials.formG', ['name' => 'name', 'type' => 'text', 'text' => 'Nom discipline', 'class'=>'', 'required' => true, 'additionalInfo' => ['id' =>  'namefield'] ])
                      </div>
        ...
        <div class="col-md-4">
          ...
          <div class="box box-widget widget-user-2">
            ...
            <div class="widget-user-header bg-{{ ArrayHolder::backgroundColors()  }}">
              ...
              <!-- /.widget-user-image -->
              <h3 class="widget-user-username">{{ $discipline->name }}</h3>
