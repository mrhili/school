...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="{!! asset('games/3dchess/css/styles.css') !!}">
    <script src="{!! asset('games/3dchess/js/prefixfree.min.js') !!}"></script>
  </head>
  <body>
    ...
    <script src="{!! asset('games/3dchess/js/scripts.min.js') !!}"></script>
  </body>
</html>
